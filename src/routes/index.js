...
import IconNormatividad from "../assets/rediseno2023/imgs/iconos/menu/ico_normatividad.svg";
...
const pdnRoutes = [
  ...
  },
  {
    ...
    color: '#F29888',
    colorDegradado: 'linear-gradient(0deg, hsla(8, 73%, 73%, 1) 43%, hsla(8, 51%, 85%, 1) 100%);',
    icon: IconS1,
  ...
  },
  {
    ...
    color: '#b25fac',
    colorDegradado: 'linear-gradient(0deg, hsla(304, 35%, 54%, 1) 43%, hsla(304, 40%, 70%, 1) 100%);',
    icon: IconS2,
  ...
  },
  {
    ...
    color: '#88bc69',
    colorDegradado: 'linear-gradient(0deg, hsla(98, 38%, 57%, 1) 43%, hsla(98, 60%, 73%, 1) 100%);',
    icon: IconS4,
  ...
  },
  {
    ...
    color: '#34c9b2',
    colorDegradado: 'linear-gradient(0deg, hsla(171, 59%, 50%, 1) 43%, hsla(171, 75%, 63%, 1) 100%);',
    icon: IconS5,
  ...
  },
  {
    ...
    color: '#42a5cc',
    colorDegradado: 'linear-gradient(0deg, hsla(197, 58%, 53%, 1) 43%, hsla(197, 83%, 66%, 1) 100%);',
    icon: IconS6,
