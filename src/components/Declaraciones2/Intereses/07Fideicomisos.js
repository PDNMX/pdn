					...
					<Grid container spacing={1}>
						...
						<Grid item xs={12} md={4}>
							...
							<Typography className={classes.card}>
								{obj.extanjero === 'MX' ? 'EN MÉXICO' : 'EN EL EXTRANJERO'}
							</Typography>
						</Grid>
						<Divider />
							...
							<Grid item xs={12}>
								<Grid container spacing={1}>
									...
									<Grid item xs={12} md={6}>
										...
										<Typography className={classes.card}>
											{obj.fideicomitente.nombreRazonSocial}
										</Typography>
									</Grid>
									<Grid item xs={12} md={3}>
										<Typography className={classes.cardTitle}>RFC:</Typography>
							...
							<Grid item xs={12}>
								<Grid container spacing={1}>
									...
									<Grid item xs={12} md={6}>
										...
										<Typography className={classes.card}>
											{obj.fideicomisario.nombreRazonSocial}
										</Typography>
									</Grid>
									<Grid item xs={12} md={3}>
										<Typography className={classes.cardTitle}>RFC:</Typography>
...
export default function(props) {
	...
	const fideicomiso = data && (typeof data.fideicomiso !== 'undefined') ? data.fideicomiso : [];
		...
		<Grid container spacing={2} className={classes.rootPrincipal}>
			...
			<Grid item xs={12}>
				{data && data.ninguno ? (
					...
					<Fideicomisos fideicomiso={fideicomiso} />
				) : (
					<DatosReservados />
				)}
			</Grid>
