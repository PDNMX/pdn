...
class Busqueda extends React.Component {
  ...
  getEscolaridadNivel = () => {
    let url =
      "https://raw.githubusercontent.com/PDNMX/catalogos/master/S1%20-%20Declaraciones/nivel.json";
                ...
                {this.state.prov.map((p, i) => {
                  return (
                    <ExpansionPanel key={"res-" + i}>
                          ...
                          {p.finding ? (
                            ...
                            <Grid item xs={4}>
                              <Grid container spacing={0}>
                                <Grid item xs={6}>
                                  <Typography
                                    className={classes.resultadosHeading}
                                  >
                                    <Tooltip
                                      title={
                                        p.estatus
                      ...
                      {!p.finding && (
                        <ExpansionPanelDetails
                          className={classes.resultadoContenido}
                        >
                          {p.data.length > 0 && (
                            <Tabla
                              rows={p.data}
                            ...
                            <Grid container spacing={1}>
                              <Grid item xs={12}>
                                <Typography
                                  ...
                                  align="center"
                                >
                                  No se logro establecer la conexión con el
                                  proveedor, por favor intenta nuevamente mas
                                  tarde.
                                </Typography>
                              </Grid>
                            </Grid>
