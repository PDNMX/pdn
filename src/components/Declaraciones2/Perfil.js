...
class Perfil extends React.Component {
  ...
  getIngresos = (data) => {
    switch (data.metadata.tipo) {
      case "INICIAL":
        return getMoneda(
          data.declaracion.situacionPatrimonial.ingresos
            .ingresoMensualNetoDeclarante.valor * 12
        );
      case "MODIFICACIÓN":
        return getMoneda(
          data.declaracion.situacionPatrimonial.ingresos
      ...
      case "CONCLUSIÓN":
        return getMoneda(
          data.declaracion.situacionPatrimonial.ingresos
            .ingresoConclusionNetoDeclarante.valor
        );
      default:
        break;
    }
            ...
            <Paper style={{ padding: "20px 15px" }}>
              <Grid container spacing={1}>
                ...
                <Grid item xs={12} md={6}>
                  ...
                  <Typography className={classes.dataCard}>
                    {
                      data.declaracion.situacionPatrimonial
