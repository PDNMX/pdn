      ...
      <Accordion square expanded={expanded === 'panel1'} onChange={handleChange('panel1')}>
        ...
        <AccordionDetails>
          <Grid container spacing={2}>
            ...
            <Grid size={12}>
              <Typography style={{ display: 'flex' }} sx={{
                marginBottom: "16px"
              }}>
                <ButtonPDN target='_blank' href='https://drive.google.com/file/d/1wdy8bgX9fn1yRCAWSJMhjeTYKxEOXRQv/view'>
                  <Typography variant='button' className={classes.TypographyButton}>¿Qué es la PDN?</Typography>
                </ButtonPDN>

                <ButtonPDN target='_blank' href='https://drive.google.com/file/d/1YbkcDrRoscIUJtEiyM55GCliHsW22TkK/view'>
                  <Typography variant='button' className={classes.TypographyButton}>¿Cómo se construye?</Typography>
                </ButtonPDN>

                <ButtonPDN target='_blank' href='https://drive.google.com/file/d/1xYlY50lXttiuu0brV5CVd5H8qx96vDsK/view'>
                  <Typography variant='button' className={classes.TypographyButton}>Guía desarrollo PDE</Typography>
                </ButtonPDN>

                <ButtonPDN target='_blank' href='https://drive.google.com/file/d/1-IvF3KYa5rups73BmVV4W8glT9csVGY9/view'>
                  <Typography variant='button' className={classes.TypographyButton}>Seguridad de la información</Typography>
                </ButtonPDN>
              </Typography>
            </Grid>
            <Grid size={4} />
            ...
            <ol>
              <li><Typography>
                <MuiLink href='http://www.dof.gob.mx/nota_detalle.php?codigo=5445048&fecha=18/07/2016' target='_blank'>
                  ...
                  </MuiLink> artículos 9, fracciones XII, XIII y XVI; 17; 21, fracción VII, inciso b); 35, fracciones X y XI).
              </Typography>
              </li>
              <li>
                <Typography>
                  <MuiLink href='https://www.diputados.gob.mx/LeyesBiblio/pdf/LGRA.pdf' target='_blank'>
                    ...
                    </MuiLink> artículos 26, 27, 30, 31, 34, 43, 44, 46, 59 y 93.
                </Typography>
              </li>
              <li>
                <Typography>
                  <MuiLink href='https://www.dof.gob.mx/nota_detalle.php?codigo=5541802&fecha=23/10/2018' target='_blank'>
                    ...
                    </MuiLink>, las cuales establecen las directrices para el funcionamiento de la PDN y de los sistemas que la conforman, buscando garantizar en todo momento la interoperabilidad, interconexión, estabilidad, uso y seguridad de la información.
                </Typography>
              </li>
            </ol>
      ...
      <Accordion square expanded={expanded === 'panel6'} onChange={handleChange('panel6')}>
        ...
        <AccordionDetails>
          <div>
            ...
            <Typography variant='h6' sx={{
              marginBottom: "16px"
            }}>¿Cómo se está construyendo la PDN?</Typography>
            ...
            <ol>
              ...
              <ul className={classes.ul}>
                <li className={classes.li}>
                  <Link to='/especificaciones/s1' className={classes.link}><Typography sx={{
                    display: 'inline'
                  }}>Declaraciones patrimoniales y de intereses,</Typography></Link>
                </li>
                <li className={classes.li}>
                  <Link to='/especificaciones/s2' className={classes.link}><Typography sx={{
                    display: 'inline'
                  }}>Servidores públicos que intervienen en contrataciones públicas, y</Typography></Link>
                </li>
                <li className={classes.li}>
                  <Link to='/especificaciones/s3' className={classes.link}><Typography sx={{
                    display: 'inline'
                  }}>Servidores públicos y particulares sancionados</Typography></Link>
                </li>
              </ul>
            ...
            <Typography sx={{
              ...
              Para conocer más detalles sobre la seguridad de la información de la PDN, visita el <MuiLink
                target='_blank'
