...
function BusquedaParticular({ classes }) {
  ...
  const makeFiltros = () => {
    const filtros = {};
    const { nombreRazonSocial, institucionDependencia, expediente, tipoPersona, tipoSancion } = filter;
    ...
    if (institucionDependencia && institucionDependencia !== 'any')
      filtros.institucionDependencia = institucionDependencia;
    ...
    <ThemeProvider theme={ThemeV2}>
      <>
        ...
        <Grid container spacing={4}>
          <Grid item xs={12}>
            <Typography>
              <b>Busca un particular sancionado</b>
            </Typography>
          </Grid>
          ...
          <Grid item xs={12} md={2}>
            <FormControl className={classes.formControl}>
              <TextField
                ...
                select
                label="Tipo persona"
                value={filter.tipoPersona}
                onChange={(e) => setFilter({ ...filter, tipoPersona: e.target.value })}
              >
                <MenuItem value="any">
                  <em>Todos</em>
                </MenuItem>
          ...
          <Grid item md={6} xs={12}>
            <FormControl className={classes.formControl}>
              <TextField
                style={{ background: '#f2f0f2' }}
                id="institucionDependencia"
                name="institucionDependencia"
                margin="normal"
                select
                label="Institución"
                value={filter.institucionDependencia}
          ...
          <Grid item xs={12} md={1}>
            <ButtonPDN variant="contained" onClick={() => handleCleanAll()}>
              Limpiar
            </ButtonPDN>
          </Grid>
          <Grid item xs={12} md={1}>
          ...
          <Grid item xs={12}>
            {loading && (
              <Modal id="modalIsela" open={loading}>
                <div>
        ...
        {view === 1 && previos && previos.length > 0 && (
          <Grid container>
            <Grid item xs={12} className={classes.section}>
              <Previos data={previos} handleChangeSujetoObligado={handleChangeSujetoObligado} />
            </Grid>
          </Grid>
        )}
        {/* Tabla */}
        ...
        {view === 3 && selectedItem !== null && (
          <DetalleParticularSancionado hideDetalle={hideDetalle} particular={selectedItem} />
        )}
      </>
    </ThemeProvider>
  );
