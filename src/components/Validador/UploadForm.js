        ...
        if (Object.values(formValidity).every(Boolean)) {         
          ...
          reader.onloadend = (event) => {
            ...
            try {
              ...
              switch (tipoEsquema) {
                case 's1I':
                  urlTipoSistema = 'https://raw.githubusercontent.com/PDNMX/api_docs/master/S1/oas/OAS_API_Declaraciones_Inicial.json';
                  esquemaOAS = 'resDeclaraciones'
                  break;
                case 's1M':
                  urlTipoSistema = 'https://raw.githubusercontent.com/PDNMX/api_docs/master/S1/oas/OAS_API_Declaraciones_Modificacion.json';
                  esquemaOAS = 'resDeclaraciones'
                  break;
                case 's1C':
                  urlTipoSistema = 'https://raw.githubusercontent.com/PDNMX/api_docs/master/S1/oas/OAS_API_Declaraciones_Conclusion.json';
                  esquemaOAS = 'resDeclaraciones'
                  break;
                case 's2':
                  urlTipoSistema = 'https://raw.githubusercontent.com/PDNMX/api_docs/master/S2/oas/OAS_API_servidores_intervienen_contrataciones.json';
                  esquemaOAS = 'resSpic'
                  break;
                case 's3P':
                  urlTipoSistema = 'https://raw.githubusercontent.com/PDNMX/api_docs/master/S3/oas/OAS_API_Particulares_Sancionados.json';
                  ...
                  .then(results => {
                      Parser.validate(results)
                          .then((esquema) => {
                              ...
                              let validate = ajv.compile(esquema.components.schemas[esquemaOAS]);
            ...
            <div className={classes.root}>
                <form onSubmit={this.handleSubmit}>
                  <FormControl className={classes.formControl}>
                    <Button variant="contained" component="label" disabled={this.state.disabled} size='large' className={classes.button2}>
                      {/* <i className="material-icons">cloud_upload</i> */}
                      Cargar Archivo
                        <input name="uploadJson" onChange={this.handleChange} accept="application/json" type="file" style={{ display: "none" }}
                        />
                    </Button>
                    <div className="invalid-feedback">{formErrors.uploadJson}</div>
                  </FormControl>
                  <FormControl className={classes.formControl}>
                    <InputLabel id="demo-simple-select-required-label">Sistema</InputLabel>
                    <Select
