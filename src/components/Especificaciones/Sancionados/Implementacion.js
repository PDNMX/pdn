...
import diccionario from './PDN - Análisis propuesta Serv Púb Sanc y Part Sanc.xlsx';
const styles = theme =>({
    root: {
        flexGrow: 1
    },
