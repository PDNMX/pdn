...
const Intro = props => {
  ...
  return (
    <div className={classes.root}>
      ...
      <List>
        {
                    etapas.map((e, i) => (
                      <ListItem key={i}>
                        ...
                        <ListItemText primary={<Typography className={classes.title}>{e.etapa}</Typography>} secondary={<Typography className={classes.text} fontSize='small'>{e.descripcion}</Typography>} />
                      </ListItem>
                    ))
                }
      </List>
      ...
      <ButtonPDN
        href='https://docs.google.com/spreadsheets/d/1DDpMvPG9S1H45YMAFlHBZy9jnJu71nU1Y9CEIbxRSRQ/edit?usp=sharing'
      ...
      <Typography paragrap className={classes.text}>
      ...
      <Typography className={classes.text} marginTop='5px' marginBlockEnd='10px'>
      ...
      <Typography className={classes.text} marginTop='5px'>
      ...
      <Typography paragraph className={classes.title} marginTop='10px'>
