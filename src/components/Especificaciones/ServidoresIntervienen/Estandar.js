        ...
        return (
            <div className={classes.root}>
                ...
                <Typography paragraph>
                    ...
                    Se presenta el modelo de interoperabilidad que deberán adoptar los diversos sistemas de información que proveerán
                ...
                <Typography paragraph>
                    ...
                    interoperabilidad de los datos. El Estándar para la Interoperabilidad de Datos de Servidores Públicos que Intervienen en Contrataciones
                    surge a partir de la necesidad de distribuir, comparar y analizar
                ...
                <Typography paragraph>
                    ...
                    sin importar la tecnología con la que dichos sistemas fueron desarrollados
                ...
                <p>
                    <Button variant="contained" className={classes.button} href="https://github.com/OAI/OpenAPI-Specification">
                        Más información
                    </Button>
                </p>
                ...
                <p>
                    <Button variant="contained" className={classes.button} href="https://oauth.net/2/">
                        Más información
                    </Button>
                </p>
            </div>)
