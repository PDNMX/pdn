...
const rows = [
    createData('api_key', "Token que devuelve la institución al autenticar a la PDN para permitir el uso de la api de declaraciones",
        "N/A",
        "N/A"),
    ...
    createData('page_size', "Número de registros a mostrar por página.",
        "1-200",
        "10"),
    createData('nombres', "Nombre o nombres del declarante, la respuesta debe arrojar todos los registros que coincidan en forma total o parcial a la cadena enviada.",
        "N/A",
        "N/A"),
    createData('apellido1', "Primer apellido del declarante, la respuesta debe arrojar todos los registros que coincidan en forma total o parcial a la cadena enviada.",
        "N/A",
        "N/A"),
    createData('apellido2', "Segundo apellido del declarante, la respuesta debe arrojar todos los registros que coincidan en forma total o parcial a la cadena enviada.",
        "N/A",
        "N/A"),
    createData('curp', "CURP del declarante, devuelve todos los registros que coincidan completamente con el valor enviado.",
        "N/A",
        "N/A"),
    createData('rfc', "RFC del declarante, devuelve todos los registros que coincidan completamente con el valor enviado.",
        "N/A",
        "N/A"),
