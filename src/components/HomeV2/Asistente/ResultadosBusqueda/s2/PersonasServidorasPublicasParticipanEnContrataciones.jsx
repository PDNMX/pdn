...
import { Table, TableBody, TableCell, TablePagination, TableRow, TableFooter, Button, Box, Typography, Modal } from '@mui/material'
    ...
    <>
      ...
      {showResultsTable && state.results && state.results.length > 0 &&
        <Box p={1}>
          ...
          <div className={classes.container}>
            <Table
              aria-describedby='spinnerLoading' id='tableServidores'
