...
const AnimatedCanvas = () => {
  ...
  useEffect(() => {
    ...
    function init() {
      ...
      opts.vanishPoint.x = (canvas.width = window.innerWidth) / 2;
      opts.vanishPoint.y = (canvas.height = window.innerHeight) / 2;
      ctx.fillRect(0, 0, canvas.width, canvas.height);
    ...
    Connection.prototype.link = function () {
      ...
      let alpha, beta, len, cosA, sinA, cosB, sinB;
      const pos = {};
      let passedExisting, passedBuffered;
    ...
    Data.prototype.draw = function () {
      if (this.ended) return --this.ended; // not sure why the thing lasts 2 frames, but it does
