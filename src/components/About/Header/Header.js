            ...
            <div className={classes.root}>
                ...
                <Grid container spacing={0} className={classNames(classes.container1, 'servidores')} justify='center'>
                    ...
                    <Grid item xs={12} md={6} className={classes.item2} align={isWidthUp('md', this.props.width)? 'left':'center'} >
                        <Typography variant="h3" paragraph className={classes.whiteText} style={{fontWeight: 300}}>
                            ¿Qué es la Plataforma Digital Nacional?
                        </Typography>
                        <Typography className={classes.whiteText} style={{fontSize: '18px',fontWeight: 500}}>
                        La Plataforma Digital Nacional es una fuente de inteligencia para construir integridad y
combatir la corrupción, que creará valor para el gobierno y la sociedad, a partir de grandes
cantidades de datos.
                        </Typography>
                        <Typography  className={classes.whiteText} style={{fontSize: '18px',fontWeight: 500}}>
                        La Plataforma es un medio para el intercambio de datos anticorrupción del Gobierno, que
busca quitar barreras y romper silos de información para que los datos sean comparables,
accesibles y utilizables, empezando con seis sistemas de datos prioritarios.
                        </Typography>
                    </Grid>
                </Grid>
            </div>
