                ...
                <Grid container spacing={0} justify='center' className={classes.bgPanelTable}>
                    <Grid item xs={12} className={classes.sectionT}>
                        ...
                        <Typography variant={"body1"} className={classes.desc}>
                            ...
                            1. <b>Ejercicio.</b>Permite conocer el comportamiento de los datos a través de los ejercicios <a href="#g1">Ver</a><br/>
                            2. <b>Puesto.</b> En la APF se encuentra una gran variedad de procesos de contratación, aquí se puede encontrar información de los puestos que más intervienen en procesos de contratación. Debido a que se encontraron 13,088 puestos diferentes, se muestra la información de los 10 más comunes.<a href="#g2">Ver</a><br/>
                            3. <b>Ramo, Institución, Unidad Responsable y Puesto.</b>En está sección se podrán encontrar diferentes visualizaciones que muestran el comportamiento y la relación entre estás variables <a href="#g3">Ver</a><br/>
