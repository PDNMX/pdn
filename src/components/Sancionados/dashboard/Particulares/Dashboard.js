...
import SentidoResoluciones from "./legacy/SentidoResoluciones";
import SentidoResolucionesAnio from "./legacy/SentidoResolucionesAnio";
import DependenciasSanciones from "./legacy/DependenciasSanciones";
import '../Servidores/legacy/graficas.css';
