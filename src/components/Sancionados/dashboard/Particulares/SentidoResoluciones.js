                ...
                <Grid container spacing={0} justify='center' className={classes.frameChart}>
                    ...
                    <Grid item xs={12} md={4} className={classes.descripcion}>
                        <Typography variant={"body1"}>
                            La Secretaría de la Función Pública, de acuerdo con la Ley General de Responsabilidades
                            Administrativas, engloba el sentido de las resoluciones en: Absolutoria, Sancionatoria,
                            Sancionatoria con multa y Sancionatoria con multa e inhabilitación.
                            Como muestra la gráfica de la izquierda, del 2004 a la fecha, de las 1742 resoluciones en
                            total, la mayoría derivó en sanción con multa e inhabilitación (1317 en total), seguido por
                            sanciones con multa con un total de 366, 36 sancionatorias, 1 absolutoria y 22 que no
                            especifican el sentido de la resolución.
                        </Typography>
                    </Grid>
                    <Grid item xs={12} className={classes.descripcion}>
                        <Typography variant={"body1"}>
                            A lo largo del tiempo, se aprecia que del total de resoluciones por año, el mayor número de
                            sanciones termina en Sancionatorias con multa e inhabilitación, las demás resoluciones
                            tienen una presencia partical a lo largo de los años, siendo el año 2009 donde hubo 10
                            resoluciones sancionatorias y el año 2011 donde se presentó el mayor número de resoluciones
                            sancionatorias con multa.<br/>
                            El año 2010, que fue el que mayor número de sanciones presentó, se descompone en 187
                            resoluciones sancionatorias con multa e inhabilitación, 50 resoluciones sancionatorias con
                            multa y 2 sancionatorias.
                        </Typography>
                    </Grid>
