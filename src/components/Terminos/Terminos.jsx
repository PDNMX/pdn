...
// import bgi/mg from "../../assets/rediseno/fondo_cruces_dark.png";
            ...
            <Box className={classes.box}>
              ...
              <ul className={classes.ul}>
                <li className={classes.li}>
                  <Typography display='inline'>
                      <Link target='_blank' href='https://www.diputados.gob.mx/LeyesBiblio/ref/lgsna.htm' rel='noreferrer'>Ley General del
                ...
                <li className={classes.li}>
                  <Typography display='inline'>
                      <Link target='_blank' href='https://www.diputados.gob.mx/LeyesBiblio/ref/lgra.htm' rel='noreferrer'>Ley General
                ...
                <li className={classes.li}>
                  <Typography display='inline'>
                      <Link target='_blank' href='https://www.dof.gob.mx/nota_detalle.php?codigo=5541802&fecha=23/10/2018' rel='noreferrer'>Bases
              ...
              <ul className={classes.ul}>
                <li className={classes.li}><Typography display='inline'>Citar a la Plataforma Digital
                  Nacional como fuente de los datos mencionando, por lo menos:
                                             </Typography>
                  <ul>
                      <li><Typography display='inline'>Nombre del sistema de la PDN por el que se
                        consultaron los datos;</Typography>
                      </li>
