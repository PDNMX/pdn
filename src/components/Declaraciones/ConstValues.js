...
export const SalaryChartConf = [
  [null,100000], [100000, 300000], [300000, 600000], [600000, null ]
];
...
export const ChartColors = ["#8C5B6C", "#F5C48A", "#14ABBD", "#F5786F", "#99B898", "#F2355B", "#191226"];
