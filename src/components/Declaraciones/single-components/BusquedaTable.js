      ...
      <tr key={"result-tr-" + i}>
        <td>
          <a href={`${process.env.PUBLIC_URL}/perfil/${el._id}/informacion`}>
            {general.nombres} {general.primer_apellido}{" "}
            {general.segundo_apellido}
          </a>
        </td>
        <td>{encargo.ente_publico}</td>
        <td>{encargo.empleo_cargo_comision}</td>
        <td>{encargo.direccion_encargo.entidad_federativa.nom_agee}</td>
        <td>{encargo.direccion_encargo.municipio.nom_mun}</td>
      </tr>
    );
  }
