...
/*
  ...
  ////////////////////////////////////////////////////////////////////////////////
*/
class IngresosEnajenacion extends Component{
  constructor(props){
    super(props);

    let elems = this.props.profile.ingresos.enajenacion_bienes.map(d => {
                  // let item = d;
                  d.show = true;
  ...
  render(){
    return(
      <Grid container spacing={3} direction={'row-reverse'} className="col-sm-offset-3 sidecontent">
        ...
        <h2>Enajenación de bienes ({this.items().length})</h2>
        {/* row */ }
          ...
          <Grid item xs={12}>
            ...
            <Paper className="pdn_d_box" key={"sueldo-" + i} id={"sueldo-" + i}>
              ...
              <div style={ {display : (sueldo.show ? "block" : "none")} }>
                ...
                <Grid container spacing={3}>
                  <Grid item xs={12}>
                    <p className="pdn_label">Descripción de bienes</p>
                    <p className="pdn_data_p">{sueldo.descripcion_bien}</p>
                  </Grid>
  ...
  items(){
    return this.props.profile.ingresos.enajenacion_bienes;
  }
}
...
/*
  ...
  ////////////////////////////////////////////////////////////////////////////////
*/
export default IngresosEnajenacion;
