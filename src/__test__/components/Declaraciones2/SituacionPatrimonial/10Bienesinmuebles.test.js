...
describe('Declaraciones', () => {
  ...
  data.forEach((dato, index) => {
    const { datosGenerales, bienesInmuebles } = dato.declaracion.situacionPatrimonial;
    const { nombre, primerApellido, segundoApellido } = datosGenerales;

    describe(`10Bienesinmuebles id:${dato.id} nombre:${nombre}|${primerApellido}|${segundoApellido}`, () => {
      test('montar', () => {
